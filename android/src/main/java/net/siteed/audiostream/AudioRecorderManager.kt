...
class AudioRecorderManager(
    ...
    companion object {
        ...
        fun initialize(
            ...
            return instance ?: synchronized(this) {
                instance ?: AudioRecorderManager(
                    ...
                    app.registerActivityLifecycleCallbacks(it.lifecycleCallbacks)
                }
            }
        }
        ...
        fun destroy() {
            instance?.cleanup()
            instance = null
            val app = instance?.context?.applicationContext as? android.app.Application
            app?.unregisterActivityLifecycleCallbacks(instance?.lifecycleCallbacks)
        }
    }
                                        ...
                                        mainHandler.post {
                                            try {
                                                if(!isAppInBackground) {
                                                    ...
                                                    LogUtils.d(CLASS_NAME, "Skipping sending audio_analysis_event to device...")
                                                }
                                            } catch (e: Exception) {
        ...
        mainHandler.post {
            try {
                if(!isAppInBackground) {
                    ...
                    LogUtils.d(CLASS_NAME, "Skipping sending audio_event to device...")
                }
            } catch (e: Exception) {
