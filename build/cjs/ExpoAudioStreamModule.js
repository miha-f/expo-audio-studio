...
const ExpoAudioStream_web_1 = require("./ExpoAudioStream.web");
...
if (react_native_1.Platform.OS === 'web') {
    ...
    ExpoAudioStreamModule = (webProps) => {
        if (!instance) {
            instance = new ExpoAudioStream_web_1.ExpoAudioStreamWeb(webProps);
        }
        return instance;
    };
...
if (react_native_1.Platform.OS !== 'web') {
    ExpoAudioStreamModule = (0, expo_modules_core_1.requireNativeModule)('ExpoAudioStream');
}
exports.default = ExpoAudioStreamModule;
